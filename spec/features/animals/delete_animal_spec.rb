...
RSpec.describe "Delete an Animal", type: :feature do
  xit "has a link to delete an animal" do

    animal_show_json_response = File.read("spec/fixtures/animals_show.json")
    stub_request(:get, "http://localhost:5000/api/v1/shelters/1/animals/1").
      ...
      to_return(status: 200, body: animal_show_json_response, headers: {})
